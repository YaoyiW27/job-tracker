...
- [ ] **P1b** — Manual **"Add row"** dialog (primary entry point) with URL-prefill field; duplicate-warning flow
- [ ] **P1c** — Editable TanStack table (inline status/notes/appliedDate)
